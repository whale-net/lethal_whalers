...
from openapi_client.models.package_submission_metadata import \
    PackageSubmissionMetadata
from openapi_client.models.package_submission_result import \
...
class ApiClient:
    ...
    def user_media_initiate_upload(
        self, filename: str
    ) -> UserMediaInitiateUploadResponse:
        ...
        parm = UserMediaInitiateUploadParams(
            filename=filename, file_size_bytes=file_size_bytes
        )
        response = self._session.post(
            self.__BASE_API_URL + "/api/experimental/usermedia/initiate-upload/",
            data=parm.to_json(),
        )
    ...
    def user_media_finish_upload(
        self, uuid: str, file_part: CompletedPart
    ) -> UserMedia:
    ...
    def submit_submission(self, uuid: str) -> PackageSubmissionResult:
        ...
        response = self._session.post(
            self.__BASE_API_URL + "/api/experimental/submission/submit/",
            parms.to_json(),
        )
